...
<html lang="en">
 ...
 <header>
   ...
   <div class="collapse navbar-collapse" id="navbar-collapse" style="margin-right:60px;">
     ...
     <div class="container">
	  <div class="row">
		 <div class="col-md-4" class="text-justify " >
          <center><img src="image/SMJ.png" style="width:50%;height:300px; margin-top:50px;" ></center>
            </div>
 
  <div class="col-md-7 col-md-offset-1" >
  <iframe src="constituentyfull.html" style="width:100%;height:500px;"></iframe>
 </div>
 </div></div>
